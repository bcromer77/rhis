        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <CardHeader>
              ...
              <CardTitle className="text-slate-800">Pricing</CardTitle>
              <CardDescription className="text-slate-600">Enterprise subscription plans and features</CardDescription>
            </CardHeader>
          </Card>
